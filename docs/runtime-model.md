...
attributed peer message and taken up at its next processing boundary — between
tool calls of a turn in flight, not after it ends. That is why the anchor works for a
